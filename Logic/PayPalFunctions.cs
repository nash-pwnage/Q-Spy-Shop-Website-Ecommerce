...
public class NVPAPICaller
{
    ...
    public string APIUsername = "seller_api1.mpettersson.com";
    private string APIPassword = "1367928157";
    private string APISignature = "A9nI75qFPsOGS-88PLzXyIAdLsQmATmshy7LNguuFlF9wnlBoJDky7bG";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "http://localhost:49414/Checkout/CheckoutReview.aspx";
        string cancelURL = "http://localhost:49414/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Q's Spy Shop Sample Application";
        ...
        QsSpyShop.Logic.ShoppingCartActions myCartOrders = new QsSpyShop.Logic.ShoppingCartActions();
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            QsSpyShop.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
